...
@Freezed(genericArgumentFactories: true)
class ProductsByCategoryPagingApiResponse<T>
    with _$ProductsByCategoryPagingApiResponse<T> {
  const factory ProductsByCategoryPagingApiResponse({
    required T data,
    required MetaApiResponse meta,
  }) = _ProductsByCategoryPagingApiResponse;

  factory ProductsByCategoryPagingApiResponse.fromJson(
          Map<String, dynamic> json, T Function(Object?) fromJsonT) =>
      _$ProductsByCategoryPagingApiResponseFromJson(
          {
            'data': json['data']['data'],
            'meta': json['data']['meta'],
          },
